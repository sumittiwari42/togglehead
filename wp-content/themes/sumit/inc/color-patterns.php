 ...
 */
function sumit_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'sumit_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.sumit-front-page) .entry-title,
...
.colors-custom .sumit-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.sumit-front-page .panel-content .recent-posts article,
...
.colors-custom.sumit-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'sumit_custom_colors_css', $css, $hue, $saturation );
}
